...
ConvertFrom-StringData @'
	...
	optionwithoutexe0 = IT LOOKS LIKE Pobierak STILL NEED THE NECESSARY *.exe files TO WORK. 
...
#downloadended
ConvertFrom-StringData @'
	downloadend = THE DOWNLOAD COMPLETED.
'@
#warning_select_file
ConvertFrom-StringData @'
...
#downloaaudio
ConvertFrom-StringData @'
	downloadingaudio0 = DOWNLOADING AUDIO LINK NO.:
	downloadingaudio1 = REMAIN:
'@
#downloadvideo
ConvertFrom-StringData @'
	downloadingvideo0 = DOWNLOADING VIDEO LINK NO.:
...
ConvertFrom-StringData @'
	downloadsongintro = YOU HAVE CHOSEN OPTION NUMBER 1. DOWNLOADING AUDIO FROM YT USING SINGLE LINKS COPIED INTO THE TERMINAL.
...
#downloadfromlist
ConvertFrom-StringData @'
	downloadfromlistintro = YOU HAVE SELECTED OPTION NUMBER 2. DOWNLOADING AUDIO FROM YT USING LINKS FOUND IN A FILE.
'@
#downloadplaylist
ConvertFrom-StringData @'
	downloadplaylistintro = YOU HAVE CHOSEN OPTIONS NUMBER 3. DOWNLOADING AUDIO FROM YT PLAYLIST.
...
#downloadchannel
ConvertFrom-StringData @'
	downloadchannelintro = YOU HAVE CHOSEN OPTIONS NUMBER 4. DOWNLOADING AUDIO FROM WHOLE YT CHANNEL
...
ConvertFrom-StringData @'
	fun5intro = YOU HAVE CHOSEN THE OPTION NUMBER 5. DOWNLOADING VIDEO AND/OR AUDIO VIA LINKS SAVED IN A FILE OR ENTERED IN TERMINAL.
...
ConvertFrom-StringData @'
	...
	downloadfromcookieinfo = ENTER A VALID VALUE: firefox OR brave :
	downloadfromcookieaudio0 = AUDIO WILL BE DOWNLOADED FIRST.
	downloadfromcookieaudio1 = AUDIO DOWNLOAD IN PROGRESS..
...
ConvertFrom-StringData @'
	...
	news00 = 3.490 ; Enhanced code readability and comments ; Folder selection window stays on top in Win11 ; Safe argument splatting for yt-dlp ; Improved link normalization using Normalize-YouTubeLink ; Fixed line counting and input file filtering ; Simplified and robust PID retrieval ; Closed quotes in download_from_cookie + added Windows variant (--cookies-from-browser firefox/chrome/edge) ; Added hardcoded link for FFMPEG 8.0 ; Removed problematic yt-dlp version checker
	...
	ffmpgupd00 = DOWNLOADING THE CONVERTER FROM THE GITHUB REPOSITORY .. IT MAY TAKE A WHILE . PLEASE WAIT, THIS MAY TAKE A FEW MINUTES ;)
	...
	ytdlpupd01 = YT-DLP DOWNLOAD COMPLETED!!!
	...
	updmenu07 = MAKE YOUR SELECTION BY ENTERING THE RIGHT OPTION NUMBER.
	updmenu08 = PRESS ENTER TO CONFIRM:
'@
#ytdlpdev
ConvertFrom-StringData @'
	ytdlpdevintro01 = WELCOME TO POBIERAK FOR AMBITIOUS  ;)
	...
	ytdlpdev00 = ENTER ARGUMENTS AND PRESS ENTER TO CONFIRM.
