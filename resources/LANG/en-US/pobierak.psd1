...
ConvertFrom-StringData @'
	...
	news00 = -Significant improvements in language handling thanks to the  the B.A -slightly improved filter for detecting playlists in links -improved code readability and variable handling -significant shortening of the code -improved error handling
