...
ConvertFrom-StringData @'
	...
	news00 = 3.452 fixed variable name in option 7 qualit -> quality ; option no. 5 in the menu - video downloading works again ; Improved cookie extraction from edge and chrome ; fixed errors in the information area ;
