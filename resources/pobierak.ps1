...
Function updates_menu(){
        ...
        if ( $instal_or_not -eq 1 )
            {
				...
				Copy-Item  -Path $path_to_temp\pobierak\pobierak4windows-main\resources\whats_new.txt $pobierakbat_main_dir\whats_new_pl.txt #COPY NEWS ABOUT POBIERAK TO TO MAIN DIR
				Copy-Item  -Path $path_to_temp\pobierak\pobierak4windows-main\resources\whats_new.txt $pobierakbat_main_dir\whats_new_en.txt #COPY NEWS ABOUT POBIERAK TO TO MAIN DIR
    ...
    Function download_ffmpeg(){
        ...
        Start-BitsTransfer -Source "https://github.com/GyanD/codexffmpeg/releases/download/2022-09-07-git-e4c1272711/ffmpeg-2022-09-07-git-e4c1272711-essentials_build.zip" -Destination "$recources_main_dir\ffmpeg.zip"
